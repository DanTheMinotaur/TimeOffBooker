...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { holiday_date: @holiday.holiday_date, reason: @holiday.reason } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { holiday_date: @holiday.holiday_date, reason: @holiday.reason } }
